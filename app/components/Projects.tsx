...
function Projects() {
  return (
    <section
      id="projects"
      className="max-w-[88%] md:max-w-[80%] mx-auto py-10 lg:py-24 px-4"
    >
      ...
      <div className="w-full flex flex-col items-center justify-center gap-28 mt-10">
        ...
        <div className="flex flex-col xl:flex-row-reverse gap-6">
          ...
          <div
            className="w-full md:w-3/5 flex flex-col gap-6 lg:justify-between
          ...
          >
            ...
            <h3 className="text-2xl font-bold ">Amazon Clone</h3>
            <p className="bg-[#112240] md:-mr-16  text-sm md:text-base p-2  rounded-md">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.{" "}
              <span className="text-green-500">
                Error pariatur eum aliquam dignissimos blanditiis
              </span>
